    ...
    navbar.innerHTML = `
      <div class="nav-inner">
        ...
        <div class="nav-links">
          ...
          <a
            href="#/"
            class="nav-link ${router.currentRoute === '/'
        ? 'active'
        : ''
      }"
          >
          ...
          <a
            href="#/projects"
            class="nav-link ${router.currentRoute &&
        router.currentRoute.startsWith('/project')
        ? 'active'
        : ''
      }"
          >
          ...
          <a
            href="#/customizer"
            class="nav-link ${router.currentRoute === '/customizer'
        ? 'active'
        : ''
      }"
          >
          ...
          <a
            href="#/custom-project"
            class="nav-link ${router.currentRoute === '/custom-project'
        ? 'active'
        : ''
      }"
          >
        ...
        ? `
                ...
                <button
                  ...
                  onclick="window.toggleNotifPanel()"
                  title="Notifications"
                >
                  <i
                    data-lucide="bell"
      ...
      <div class="container">
        ...
        <div class="footer-grid">
          ...
          <div class="footer-brand">
            ...
            <a
              href="#/"
              class="logo flex gap-sm align-center text-heading font-bold text-xl"
            ...
            <p>
              ...
              Build, learn, and innovate with
              our production-ready kits.
            </p>
          ...
          <div class="footer-col">
            ...
            <a href="#/projects?category=arduino">
              Arduino
            </a>

            <a href="#/projects?category=esp32">
              ESP32 & NodeMCU
            </a>

            <a href="#/projects?category=raspberry-pi">
              Raspberry Pi
            </a>

            <a href="#/projects?category=iot">
              Internet of Things
            </a>

            <a href="#/projects?category=robotics">
              Robotics
            </a>
...
async function initApp() {
  ...
  const savedAdmin =
    localStorage.getItem('ck_admin_user');
